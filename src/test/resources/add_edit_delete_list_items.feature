...
Feature: As a user I want to add, edit, delete, modify and list items
    ...
    Scenario: user can list one item
        ...
        When user does nothing
        Then system will respond with "Book: Title by Author"
    ...
    Scenario: user can list multiple items
        ...
        When user does nothing
        Then system will respond with "Book: Book1 by Author1"
        Then system will respond with "Book: Book2 by Author1"
        Then system will respond with "Book: Book3 by Author2"
        Then system will respond with "Book: Book4 by Author3"
